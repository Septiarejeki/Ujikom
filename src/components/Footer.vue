<template>
    <footer class="relative mt-20 bg-yellow-400 px-4 pt-20">
  <div class="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 border-brown-500 bg-white p-2"><img class="h-full object-contain" src="../assets/img/logoc.webp" alt="" /></div>
  ...
  <p class="py-10 text-center text-white-300">© 2022 Boleno | All Rights Reserved</p>
</footer>
</template>
